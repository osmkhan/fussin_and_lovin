...
const OUTPUT_PATH = path.join(__dirname, '../../src/data/raw/pdf_archive_new.txt');
const CSV_OUTPUT_PATH = path.join(__dirname, '../../src/data/raw/pdf_parsed_entries_new.csv');
