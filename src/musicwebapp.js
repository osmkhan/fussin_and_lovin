...
export default function MusicWebApp() {
  ...
  return (
    <div className="relative bg-[#ede5d0] text-[#222] min-h-screen font-serif selection:bg-[#bfa77a]/60" style={{minHeight: '100vh', minWidth: '100vw', overflowX: 'hidden'}}>
      ...
      {(!heroDismissed) && (
        <section
          className={`fixed inset-0 z-50 flex items-center justify-center pointer-events-auto bg-gradient-to-b from-[#f8f5f0] via-[#ede5d0] to-[#d6c7a1] transition-all duration-[2500ms] ease-in-out
      ...
      <main className="relative z-10 pt-16 px-6 md:px-10 pb-16">
        <Tabs defaultValue="list" className="w-full">
          <TabsList className="flex gap-4 mb-8">
            ...
            <TabsTrigger value="summary" className="font-bold text-[#191414] tracking-wide" style={{fontFamily: 'Inter, Helvetica, Arial, sans-serif', fontSize: '1.1rem'}}>Summary</TabsTrigger>
          </TabsList>
          ...
          {/* Summary Tab */}
          <TabsContent value="summary" className="p-8 bg-[#f0e6d2] rounded-xl border border-[#bfa77a]/40">
            <div className="space-y-6">
              <h2 className="text-2xl font-bold text-[#191414]">Artist Information Summary</h2>
              
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card className="bg-[#1f2b38] border-[#c5a77d]">
                  <CardContent className="p-6 text-center">
                    <div className="text-3xl font-bold text-[#d9a441]">144</div>
                    <div className="text-[#e7e3d7]">Total Artists</div>
                  </CardContent>
                </Card>
                <Card className="bg-[#1f2b38] border-[#c5a77d]">
                  <CardContent className="p-6 text-center">
                    <div className="text-3xl font-bold text-[#d9a441]">31</div>
                    <div className="text-[#e7e3d7]">Artists with Info</div>
                  </CardContent>
                </Card>
                <Card className="bg-[#1f2b38] border-[#c5a77d]">
                  <CardContent className="p-6 text-center">
                    <div className="text-3xl font-bold text-[#d9a441]">21.5%</div>
                    <div className="text-[#e7e3d7]">Coverage</div>
                  </CardContent>
                </Card>
              </div>
              ...
              <Card className="bg-[#1f2b38] border-[#c5a77d]">
                <CardContent className="p-6">
                  <h3 className="text-xl font-bold text-[#e7e3d7] mb-4">Information Sources</h3>
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      <span className="text-[#e7e3d7]">Wikipedia</span>
                      <span className="text-[#d9a441] font-bold">20</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-[#e7e3d7]">NPR</span>
                      <span className="text-[#d9a441] font-bold">3</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-[#e7e3d7]">Other Sources</span>
                      <span className="text-[#d9a441] font-bold">8</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-8 space-y-4 text-[#222]" style={fadeInAnim}>
                  <div style={{ position: 'relative', overflow: 'hidden' }}>
                    <img
                      ...
                      alt={selected.album}
                      style={{ width: 96, height: 96, objectFit: 'cover', borderRadius: 12, boxShadow: '0 2px 12px #bfa77a44', float: 'right', marginLeft: 24, marginBottom: 8 }}
